...
require (
	...
	github.com/orchestd/log v0.0.3
	github.com/orchestd/monitoring v0.2.0
	github.com/orchestd/servicereply v0.0.5
	github.com/orchestd/session v0.21.2
	github.com/orchestd/sharedlib v0.13.2
	github.com/orchestd/trace v0.0.11
	github.com/orchestd/transport v0.15.2
	github.com/orchestd/validations v0.5.1
