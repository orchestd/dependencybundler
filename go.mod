...
require (
	github.com/orchestd/cacheStorage v0.18.4
	github.com/orchestd/configurations v0.10.2
	github.com/orchestd/debug v0.1.3
	github.com/orchestd/log v0.1.1
	github.com/orchestd/monitoring v0.2.0
	github.com/orchestd/servicereply v0.0.5
	github.com/orchestd/session v0.21.7
	github.com/orchestd/sharedlib v0.13.2
	github.com/orchestd/trace v0.0.15
	github.com/orchestd/transport v0.15.6
	github.com/orchestd/validations v0.5.5
