...
require (
	...
	github.com/orchestd/debug v0.1.6
	github.com/orchestd/log v0.1.1
	github.com/orchestd/monitoring v0.2.2
	github.com/orchestd/servicereply v0.0.5
	github.com/orchestd/session v0.21.9
	github.com/orchestd/sharedlib v0.13.2
	github.com/orchestd/trace v0.0.17
	github.com/orchestd/transport v0.15.8
	github.com/orchestd/validations v0.5.7
